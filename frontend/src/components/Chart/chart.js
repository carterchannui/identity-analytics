    ...
    return (
        <>
            <Box display={"flex"} justifyContent={"space-between"} width={"80%"}>
                ...
                <Box display={"flex"} gap={"20px"}>
                    <Box display={"flex"} gap={"5px"} >
                        <Box>
                            <Box border={"2px solid blue"} width="2rem" display="inline-block"></Box>
                        </Box>
                        <Box>
                            <Text>Issuance</Text>
                        </Box>
                    ...
                    <Box display={"flex"} gap={"5px"} >
                        <Box>
                            <Box border={"2px solid grey"} width="2rem" display="inline-block"></Box>
                        </Box>
                        <Box>
            ...
            <ResponsiveContainer width="100%" aspect={3}>
                <LineChart data={pdata} width={500} height={250} margin={{ top: 5, right: 300, left: 20, bottom: 5 }}>
                    {/*<Line type="monotone" dataKey="data" stroke="blue" activeDot={{ r: 8 }} />*/}
                    <Line type="monotone" dataKey="key" stroke="blue" activeDot={{ r: 8 }} />
                    <Line type="monotone" dataKey="refreshment" stroke="grey" activeDot={{ r: 8 }} />
